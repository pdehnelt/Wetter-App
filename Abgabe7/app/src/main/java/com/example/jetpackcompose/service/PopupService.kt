...
class PopupService : Service() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            createNotificationChannel()
            // Start the foreground service to ensure the task runs persistently in the background.
            startForegroundService()
        }
        catch (e: Exception) {
            // Log or handle any exceptions that occur while setting up the notification channel or starting the service.
            Log.e("ServiceSetup", "Error initializing foreground service: ${e.message}")
        }
